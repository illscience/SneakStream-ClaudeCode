...
interface NightclubSimulationProps {
  children?: React.ReactNode
}

export default function NightclubSimulation({ children }: NightclubSimulationProps) {
  const { user } = useUser()
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Grid layout for Canvas and Chat */}
      <div className={children ? "grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-6" : ""}>
        {/* Canvas */}
