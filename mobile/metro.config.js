...
// Add convex directory from parent folder to watch folders
const convexDir = path.resolve(__dirname, '../convex');
config.watchFolders = [...config.watchFolders, VIRTUAL_ROOT, VIRTUAL_ROOT_UNRESOLVED, convexDir];

// Add nodeModulesPaths for convex resolution
